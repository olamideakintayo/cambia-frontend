...
const pendingVerifications = [
  {
    ...
    orderValue: 15000,
    escrowStatus: "locked",
    orderDate: "Sep 27, 2025",
    expectedPickup: "Sep 27, 2025",
    specialInstructions: "Keep in a dried place. Ensure no cross-contamination.",
    productImage: "/images/garri.jpg",
    orderDetails: {
      quantity: 1,
      serves: "3 months of weekly intake",
  ...
  },
  {
    ...
    expectedPickup: "Sep 28, 2025",
    specialInstructions: "Customer prefers it packed in a plastic container.",
    productImage: "/images/egusi-melon-seeds.jpg",
    orderDetails: {
      quantity: 1,
      serves: "2 months of weekly intake",
